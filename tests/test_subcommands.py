...
MSI_SITE_DATA={'1': {'1-5': {'end': '5',
                             'indels': {-1: {'allele_fraction': 0.1, 'mutant_depth': 10}},
                             'mutant_depth': 10,
                             'mutant_tally': 1,
                             'name': 'NAME1',
                             'range': set([1, 2, 3, 4, 5]),
                     ...
                     '7-11': {'end': '11',
                              'indels': {-3: {'allele_fraction': 1.4,
                                              'mutant_depth': 140},
                                         1: {'allele_fraction': 1.4, 'mutant_depth': 140}},
                              'mutant_depth': 280,
                              'mutant_tally': 6,
                              'name': 'NAME2',
                              ...
                              'total_sites': 5}},
               '7': {'1-5': {'end': '5',
                             'indels': {-1: {'allele_fraction': 0.2, 'mutant_depth': 10},
                                        1: {'allele_fraction': 1.7, 'mutant_depth': 85}},
                             'mutant_depth': 95,
                             'mutant_tally': 4,
                             'name': 'NAME3',
                             'range': set([1, 2, 3, 4, 5]),
